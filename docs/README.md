...
- [2026-08-29 — Creative menu tabs can be clicked with the mouse](changes/2026-08-29-creative-menu-tab-clicking.md) — the container-menu hit-test used stale control bounds and treated clicks above the panel as drops.
- [2026-08-29 — Crafting menu: mouse-clickable tabs and recipes](changes/2026-08-29-crafting-menu-mouse-tabs.md) — the tabbed recipe browser had no pointer hit-test at all, so a left click only ever crafted.
...
- [2026-08-29 - Opening a world crashed with heap corruption](changes/2026-08-29-anvil-save-file-ownership-heap-corruption.md) - DirectoryLevelStorage owns and deletes its ConsoleSaveFile, but three Anvil call sites passed it a stack object; plus how to symbolize a minidump here with no debugger installed.
- [2026-08-29 - Reloading lost block properties, chests and entities](changes/2026-08-29-anvil-load-properties-entities-block-entities.md) - the reverse block table was keyed on name alone so all metadata flattened; block entities and the entities region were never read back at all.
